...
const Slider = () => {
  ...
  return (
    <div className="slider top-3 relative h-[30rem] bg-white flex items-center justify-between">
      {/* left Arrow */}
      <div className={`absolute rounded-full bg-white text-purple-600 left-0 z-[2] items-center`+arrowStyle} onClick={prevSlide}>
          ...
          return (
            ...
            >
              <div className={slideStyle}>
                <div className="flex-1 flex justify-center items-center h-[100%] mobile:hidden">
                  <img
      ...
      <div className={`absolute rounded-full bg-white text-purple-600 right-0 items-center z-[3]`+arrowStyle} onClick={nextSlide}>
